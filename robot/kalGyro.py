...
while True:
    ...
    if t == 0:
        ...
        fil_state_mean, fil_state_cova = (kf.filter_update(fil_state_mean, fil_state_cova, x))
        fil_state_mean = (pfil_state_mean + fil_state_mean) / 2
    
    #print("{0:0.3F} {1:0.3F}".format(x, fil_state_mean1[0]))
    print("{0:0.3F} {1:0.3F} {2:0.3F}".format(fil_state_mean[2], fil_state_mean[1], fil_state_mean[0]))
    t+=1
